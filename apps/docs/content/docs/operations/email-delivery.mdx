...
<DocSummary>
  <DocSummaryItem label="Use this page when">
    You are configuring or troubleshooting transactional email for auth and invite flows.
  </DocSummaryItem>
  <DocSummaryItem label="What breaks if email fails">
    Users cannot verify accounts, reset passwords, or accept invites.
  </DocSummaryItem>
  <DocSummaryItem label="Core rule">
    Treat SMTP issues as access incidents, not as low-priority messaging bugs.
  </DocSummaryItem>
</DocSummary>
