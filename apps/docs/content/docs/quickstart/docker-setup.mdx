...
<DocSummary>
  <DocSummaryItem label="Use this page when">
    You are bringing up local infrastructure before starting the API and web apps.
  </DocSummaryItem>
  <DocSummaryItem label="You are done when">
    Postgres and Redis are healthy and your `.env` file is ready for auth flows.
  </DocSummaryItem>
  <DocSummaryItem label="Most common failure">
    One of the local ports is already in use or a container is unhealthy.
  </DocSummaryItem>
</DocSummary>
