...
| --- | --- | --- | --- |
| Admin Center | Tenant admins, security operators | `/admin` | Roles, Audit Log, Security Settings |
| Maker Center | Builders, solution engineers | `/maker` | Entities, App Studio |
| Worker Apps | End users, operators | `/worker` | My Apps |
